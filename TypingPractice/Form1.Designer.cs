namespace TypingPractice
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            var menuCategory = new System.Windows.Forms.ToolStripMenuItem("�������");
            menuCategory.ForeColor = System.Drawing.Color.White;

            var itemEnglish    = new System.Windows.Forms.ToolStripMenuItem("������");
            var itemHebrew     = new System.Windows.Forms.ToolStripMenuItem("�����");
            var itemCode       = new System.Windows.Forms.ToolStripMenuItem("�����");
            ...
            var menuMode = new System.Windows.Forms.ToolStripMenuItem("���");
            menuMode.ForeColor = System.Drawing.Color.White;

            this.menuSentences = new System.Windows.Forms.ToolStripMenuItem("������");
            var itemPassage     = new System.Windows.Forms.ToolStripMenuItem("��� ������");
            var itemGibberish   = new System.Windows.Forms.ToolStripMenuItem("����");

            this.menuLevelEasy = new System.Windows.Forms.ToolStripMenuItem("��");
            this.menuLevelMedium = new System.Windows.Forms.ToolStripMenuItem("������");
            this.menuLevelHard = new System.Windows.Forms.ToolStripMenuItem("���");
            ...
            var menuGame = new System.Windows.Forms.ToolStripMenuItem("����");
            menuGame.ForeColor = System.Drawing.Color.White;

            var itemScores   = new System.Windows.Forms.ToolStripMenuItem("�����");
            var itemMyScores = new System.Windows.Forms.ToolStripMenuItem("������ ���");
            var itemSettings = new System.Windows.Forms.ToolStripMenuItem("������");
